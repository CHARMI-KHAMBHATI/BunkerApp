 ...
 */
public class SwipeDismissRecyclerViewTouchListener2 implements View.OnTouchListener {
     ...
     */
    public SwipeDismissRecyclerViewTouchListener2(RecyclerView recyclerView, DismissCallbacks callbacks) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    if(deltaX > 0)
                    {
                        mCallbacks.onDismissedBySwipeRight(mRecyclerView, dismissPositions);
                    }
                    else
                    {
                        mCallbacks.onDismissedBySwipeLeft(mRecyclerView, dismissPositions);
                    }
