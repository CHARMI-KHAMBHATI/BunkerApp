...
public class DBAdapterM {
    ...
    private static final String DATABASE_TABLE = "time_table";
    ...
    //---opens the database---
    public DBAdapterM open() throws SQLException {
    ...
    public boolean deleteContact(String subject) {
        return db.delete(DATABASE_TABLE, DBAdapterM.SUBJECT+" = '"+subject+"'", null) > 0;
    }
