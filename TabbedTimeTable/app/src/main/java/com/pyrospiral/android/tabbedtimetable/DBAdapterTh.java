...
public class DBAdapterTh {
   ...
   // public static final String ATTENDANCE = "attendance";
    ...
    private static final String DATABASE_TABLE = "time_tableTh";
    ...
    public DBAdapterTh(Context ctx) {
        this.context = ctx;
    ...
    //---opens the database---
    public DBAdapterTh open() throws SQLException {
    ...
    public boolean deleteContact(String subject) {
        return db.delete(DATABASE_TABLE, DBAdapterTh.SUBJECT+" = '"+subject+"'", null) > 0;
    }
