...
public class DBAdapterTu {
    ...
    private static final String TAG = "DBAdapterTu";
    private static final String DATABASE_NAME = "MyDBTu";
    private static final String DATABASE_TABLE = "time_tableTu";
    ...
    public DBAdapterTu(Context ctx) {
        this.context = ctx;
    ...
    //---opens the database---
    public DBAdapterTu open() throws SQLException {
    ...
    public boolean deleteContact(String subject) {
        return db.delete(DATABASE_TABLE, DBAdapterTu.SUBJECT+" = '"+subject+"'", null) > 0;
    }
