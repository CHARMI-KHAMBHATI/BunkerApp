...
public class DBAdapterW {
    ...
    //---opens the database---
    public DBAdapterW open() throws SQLException {
    ...
    public boolean deleteContact(String subject) {
        return db.delete(DATABASE_TABLE, DBAdapterW.SUBJECT+" = '"+subject+"'", null) > 0;
    }
