...
public class SnackBar {
    ...
    public static final short LONG_SNACK = 20000;

    public static final short MED_SNACK = 10000;

    public static final short SHORT_SNACK = 5000;
    ...
    public static class Builder {
        ...
        private short mDuration = LONG_SNACK;
